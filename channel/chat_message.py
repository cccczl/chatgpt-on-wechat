...
class ChatMessage(object):
    ...
    def __str__(self):
        return f"ChatMessage: id={self.msg_id}, create_time={self.create_time}, ctype={self.ctype}, content={self.content}, from_user_id={self.from_user_id}, from_user_nickname={self.from_user_nickname}, to_user_id={self.to_user_id}, to_user_nickname={self.to_user_nickname}, other_user_id={self.other_user_id}, other_user_nickname={self.other_user_nickname}, is_group={self.is_group}, is_at={self.is_at}, actual_user_id={self.actual_user_id}, actual_user_nickname={self.actual_user_nickname}"
